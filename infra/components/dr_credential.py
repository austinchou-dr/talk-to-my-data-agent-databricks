...
def get_credential_runtime_parameter_values(
    ...
    elif isinstance(credentials, DataBricksCredentials): # ADDED FOR DATABRICKS
        rtps = [
            # {
            #     "key": "db_credential",
...
def get_database_credentials(
    ...
    try:
        ...
        if database == "snowflake":
            ...
            return credentials
        elif database == "databricks": # ADDED FOR DATABRICKS
            ...
            if test_credentials:
                ...
                try:
                    ...
                    raise ValueError("Failed to connect to DataBricks SQL server.") from e
            return credentials
