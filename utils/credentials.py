...
class DataBricksCredentials(DRCredentials):
    """DataBricks Connection credentials auto-constructed using environment variables."""
    ...
    client_id: str | None = Field(
        default=None,
        validation_alias=AliasChoices(
            AliasPath("MLOPS_RUNTIME_PARAM_DATABRICKS_CLIENT_ID"),
    ...
    client_secret: str | None = Field(
        default=None,
        validation_alias=AliasChoices(
            AliasPath("MLOPS_RUNTIME_PARAM_DATABRICKS_CLIENT_SECRET"),
    ...
    tenant_id: str | None = Field(
        default=None,
        validation_alias=AliasChoices(
            AliasPath("MLOPS_RUNTIME_PARAM_DATABRICKS_TENANT_ID"),
    ...
    db_schema: str | None = Field(
        default=None,
        validation_alias=AliasChoices(
            AliasPath("MLOPS_RUNTIME_PARAM_DATABRICKS_DB_SCHEMA"),
    ...
    def is_configured(self) -> bool:
        """
        Check if DataBricks SQL Server credentials are properly configured.
        """
        return bool(self.server_hostname and self.client_id and self.client_secret and self.tenant_id and self.http_path and self.catalog and self.db_schema)